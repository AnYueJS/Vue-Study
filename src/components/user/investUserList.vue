<template>
  <div id="investUserList">
    <div id="breadcrumb">
      <Breadcrumb>
        <Breadcrumb-item href="/investUserList">用户管理</Breadcrumb-item>
        <Breadcrumb-item href="/investUserList">投资用户</Breadcrumb-item>
      </Breadcrumb>
    ...
    <div id="search_nav">
      ...
      <Input class="search_users" v-model="value1" @on-enter="searchUsers(1)" icon="ios-search-strong" placeholder="请输入查询条件..." style="width: 200px"></Input>
    </div>
